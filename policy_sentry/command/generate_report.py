...
from policy_sentry.shared.report import Findings, create_report_template
...
def generate_report(credentials_file, download, output, report_config, include_unattached):
    ...
    for directory in account_directories:
        ...
        resource_exposure_findings = analyze_policy_directory(directory, db_session, resource_exposure_filename, 'resource_exposure')
        ...
        privilege_escalation_findings = analyze_policy_directory(directory, db_session, privilege_escalation_filename, 'privilege_escalation')
        ...
        # Network Exposure
        network_exposure_findings = analyze_policy_directory(directory, db_session, network_exposure_filename, 'network_exposure')
        ...
        credentials_exposure_findings = analyze_policy_directory(directory, db_session, credentials_exposure_filename, 'credentials_exposure')
