...
def generate_report(credentials_file, download, output, report_config, include_unattached):
    ...
    for i in range(len(base_account_directories)):
        # TODO: Add this back: first item should be: `base_account_directories[i]) + 'customer-managed/'`
        account_policy_directories.append(base_account_directories[i])
    ...
    for directory in base_account_directories:
        ...
        # Resource Exposure
        # TODO: Add this back: first item should be: `directory + 'customer-managed/'`
        resource_exposure_findings = analyze_policy_directory(directory, account_id,
        ...
        privilege_escalation_findings = analyze_policy_directory(directory, account_id,
        ...
        # Network Exposure
        network_exposure_findings = analyze_policy_directory(directory, account_id,
        ...
        credentials_exposure_findings = analyze_policy_directory(directory, account_id,
