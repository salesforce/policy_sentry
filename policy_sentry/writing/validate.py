...
from schema import And, Optional, Regex, Schema, SchemaError, Use, Or
...
# NEW: We allow either a simple ARN string OR a dictionary containing ARN and Condition
resource_schema = [Or(str, {
    "arn": str,
...
CRUD_SCHEMA = Schema(
    {
        ...
        Optional("access_level_overrides"): dict, # Allow standard overrides config
        Optional("read"): resource_schema,
        Optional("write"): resource_schema,
        Optional("list"): resource_schema,
        Optional("permissions-management"): resource_schema,
        Optional("tagging"): resource_schema,
